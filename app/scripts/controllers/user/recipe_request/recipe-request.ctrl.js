(function () {
    ...
    /**
     * Name: app/scripts/controller/recipe_request/recipe-request.ctrl.js
     * Author: MashUp
    ...
    /**
     * @ngdoc function
     * @name app.controller:RecipeRequestCtrl
     * @description
     * # RecipeRequestCtrl
     * Controller of the app
     */

    var RecipeRequestCtrl = function (recipeService, authService) {
				...
				vm.insertRecipeRequest = insertRecipeRequest;
				...
				function insertRecipeRequest() {
					...
					if (checkMetricsQuantity()) {
						...
						var value = {
							...
							'desc': vm.descRecipe,
							'user': authService.getAccountInformation().username,
							'metrics': vm.metrics
						};

						recipeService.createRecipeRequest(value)
							.then(function () {
		...
		RecipeRequestCtrl.$inject = ['recipeService', 'authService'];

    angular.module('app').controller('RecipeRequestCtrl', RecipeRequestCtrl);
